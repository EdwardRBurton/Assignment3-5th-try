...
class LabelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create label" do
    assert_difference('Label.count') do
      post labels_url, params: { label: { CEO: @label.CEO, Founded: @label.Founded, Name: @label.Name } }
    end
  ...
  test "should update label" do
    patch label_url(@label), params: { label: { CEO: @label.CEO, Founded: @label.Founded, Name: @label.Name } }
